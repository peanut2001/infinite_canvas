...
You can also pull a versioned image directly from GHCR:

```bash
docker pull ghcr.io/peanut2001/infinite_canvas:latest
docker pull ghcr.io/peanut2001/infinite_canvas:0.15.2
```
...
services:
  app:
    image: ghcr.io/peanut2001/infinite_canvas:latest
    ports:
      - "3000:3000"
    environment:
